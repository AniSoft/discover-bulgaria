...
// Stylized, hand-drawn silhouette of Bulgaria (editorial cartography, not a survey map).
const LAND =
  "M64 172C68 152 76 140 90 132C112 122 132 130 156 128C180 126 198 138 224 134C250 130 268 120 296 124C324 128 344 116 372 118C398 120 418 112 440 116C450 134 444 152 450 170C456 186 446 200 452 216C458 232 444 244 448 262C438 276 418 272 398 278C378 284 362 276 340 282C318 288 300 280 278 286C256 292 238 284 214 288C192 292 172 296 152 290C136 285 128 268 116 254C104 240 92 228 82 212C72 196 62 190 64 172Z";

const CONTOURS = [
  "M92 172C122 158 148 176 180 166C212 156 236 172 270 162C304 152 328 166 362 156C390 148 414 158 436 150",
  "M96 196C126 184 152 200 184 190C216 180 240 196 274 186C306 177 330 190 362 182C388 176 412 184 440 178",
  "M110 226C138 214 160 228 190 219C220 210 244 224 276 215C302 208 326 218 350 212C376 206 400 214 424 210",
  "M132 254C156 244 176 256 202 248C228 240 250 252 278 245C300 240 322 248 344 244",
];
