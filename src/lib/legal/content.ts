  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Ако приемете, тагът на Google се зарежда от googletagmanager.com и към Google се изпращат събития за използването на сайта. Когато тагът на Google съхранява идентификатор в браузъра ви, той използва свои собствени бисквитки, обикновено с имена _ga и _ga_NP4Y2XRK9Q, чието съдържание и срок се определят от Google, а не от нас. Ние не поставяме собствени аналитични бисквитки.",
